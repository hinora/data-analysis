  ...
  defineTest({
    ...
    before: [
      ...
      SEED_DATASET,
      {
        entity: TextChunk,
        data: [
          { datasetId: DATASET_ID, sessionId: SESSION_ID, content: "Chunk 0", orderIndex: 0, sourcePage: 1, sourceSection: "Introduction" },
          { datasetId: DATASET_ID, sessionId: SESSION_ID, content: "Chunk 1", orderIndex: 1, sourcePage: 1, sourceSection: "Introduction" },
          { datasetId: DATASET_ID, sessionId: SESSION_ID, content: "Chunk 2", orderIndex: 2, sourcePage: 2, sourceSection: "Body" },
          { datasetId: DATASET_ID, sessionId: SESSION_ID, content: "Chunk 3", orderIndex: 3, sourcePage: 2, sourceSection: "Body" },
          { datasetId: DATASET_ID, sessionId: SESSION_ID, content: "Chunk 4", orderIndex: 4, sourcePage: 3, sourceSection: "Conclusion" },
        ],
      },
    ],
